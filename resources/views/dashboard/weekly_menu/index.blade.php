<x-app-layout>
                                    ...
                                    <div class="modal-content">
                                        <div class="border-0 modal-header">
                                            <h5 class="modal-title" id="modalTitle">
                                                ...
                                                <span class="fw-light">WeeklyMenu</span>
                                            </h5>
                                        ...
                                        <form id="menuForm" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <p class="small">Create or update a weekly menu using this form.</p>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-group-default">
                                                            <label>Day</label>
                                                            <select class="form-select" id="menuDay" name="day">
                                               ...
                                               <td>Rs.{{ $menu->half_price }}</td>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <form action="{{ route('weekly-menus.destroy', $menu->id) }}"
    ...
    @push('etxtra-scripts')
        @include('dashboard.weekly_menu.script')
    @endpush
</x-app-layout>
